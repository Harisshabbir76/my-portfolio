            ...
            <li key={link.href}>
              <a 
                ...
                className={`transition-colors duration-300 ${
                  activeSection === link.href.slice(1) ? "text-primary font-medium" : "text-muted-foreground hover:text-primary"
                }`}
              >
                {link.label}
              </a>
                ...
                <li key={link.href}>
                  <a 
                    ...
                    className={`block py-3 ${
                      activeSection === link.href.slice(1) ? "text-primary font-medium" : "text-muted-foreground"
                    }`}
                    onClick={closeMenu}
                  >
                    {link.label}
